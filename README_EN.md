...
> Lost access to a Claude account but still have its exported data? Claude Export Data Reader turns that archive into a private, local reading library.

Claude Export Data Reader is a read-only desktop application for reviewing Claude conversation exports. It follows the visual language of Claude Web and focuses on restoring a familiar, comfortable reading experience—not on replacing Claude or continuing conversations.

The project is intended to reduce the loss caused by an inaccessible or suspended account: import the data you still have, browse it locally, and make long conversations easier to revisit.
...
## Important limitation: exported files
